...
<article class="cl pd-20">
    <form  class="form form-horizontal" id="add-product-form"  target="_parent">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>商品名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  value="" placeholder="请输入商品名称" id="add-name" name="name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">分类：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
				<select class="select" name="cid" id="add-category" size="1">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text"  autocomplete="off" value="1" min="0" max="1000" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请填写商品单价" id="add-price" name="price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>人气：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" autocomplete="off" value="1" min="0" max="1000"  placeholder="请填写人气" id="add-zan" name="zan" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
            </div>
        </div>
       ...
       <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="miaoshu" class="textarea" id="add-info" cols="80" rows="10" placeholder="请填写描述"></textarea>
            </div>
        </div>
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <input class="btn btn-primary radius" id="add-form-btn" type="button" value="提交">
            </div>
        </div>
    </form>
</article>
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.type == 'success'){
                    ...
                    var images=$("#add-imageurl").val();
                    if(images!=""){
                        images+=","+data.filepath+",";
                        $("#add-imageurl").val(images);
                    }else{
